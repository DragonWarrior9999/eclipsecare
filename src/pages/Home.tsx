...
export default function Home(){
    ...
    return (
        <>
            <div className="border border-violet-400  bg-babyblue h-[120px] w-screen">THIS IS THE HOME PAGE</div>
            ...
            <Section className="bg-babyblue min-h-[460px] lg:min-h-[520px] pb-[20px] ">
                <div className="border border-violet-400  grid h-full lg:grid-cols-12">
                    <div className="border border-violet-400  w-full mt-[30px] sm:mt-[70px] lg:col-span-7 text-navy">
                        <div className="border border-violet-400  p-[20px]">
                            <p className="text-center sm:text-left">Welcome to EclipseCare</p>
                            <h1 className="border border-red-400   sm:text-h1-base text-h1-sm text-center sm:text-left">Your Life Our Mission.</h1>
                        ...
                        <div className="border border-violet-400 text-center sm:text-left p-[20px]">
                    ...
                    <div className="border border-violet-400  w-full lg:col-span-5 relative hidden lg:block">
                        <div className="border border-violet-400   top-[20px] right-[-40px] relative min-h-[460px] min-w-[590px] rounded-lg"
                            style={{
            ...
            <Section className="pt-[60px] pb-[20px] bg-white text-navy min-h-[500px] border">
                <div className="border border-violet-400 text">
                ...
                <div className="border border-violet-400  mt-[10px] text flex-col flex md:flex-row justify-center gap-10">
                        <div className="border border-violet-400  w-full md:max-w-[320px] rounded-lg min-h-[200px] cards">
                        ...
                        <div className="border border-violet-400  w-full md:max-w-[300px] rounded-lg min-h-[200px] cards">
            ...
            <Section className="min-h-[400px] mt-[30px] bg-primarydark">
                <div className="border border-violet-400  sm:p-[40px]">
                    <SplitBanner img_src={img_smiling} image="left" className="bg-white text-navy rounded-lg min-h-[320px] ">
                        <h1 className="border border-red-400   sm:text-h1-base text-h1-sm mt-[30px] text-center sm:text-left">Iaculis ar maecenas</h1>
            ...
            <Section className="min-h-[620px] bg-white hidden sm:block">
                <div className="border border-violet-400  pt-[40px]">
                    <Quads
                        className=""
                        top_left={
                            <div className="border border-violet-400  text">
                        ...
                        top_right={
                            <div className="border border-violet-400  h-full">
                                <div className="border border-violet-400  mt-[10px] border border-orange rounded-lg h-[250px]"
                                    style={{
            ...
            <Section className="bg-babyblue p-[40px] hidden sm:block">
                    ...
                    left={
                        <div className="border border-violet-400  text-white">
                            <h2 className="text-h2-sm sm:text-h2-base">Whatever you want to achieve, we’ll help you get there.</h2>
                        </div>
                    }
                    right={
                        <div className="border border-violet-400  flex flex-wrap items-center gap-4 justify-end">
            ...
            <Section className="bg-white min-h-[600px] pt-[100px]">
                <div className="border border-violet-400  min-h-[400px] lg:grid grid-cols-12">
                    <div className="border border-violet-400  flex justify-center lg:block col-span-6">
                        <Form></Form>
                    </div>
                    <div className="border border-violet-400  col-span-6 border p-[10px]">
                    </div>
                </div>
            </Section>
            <Footer></Footer>
