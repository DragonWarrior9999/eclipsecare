        ...
        <>
            <HeroV2>
                <div className="text-center sm:text-left text">
                    <p>Our services</p>
                    <h1 className="text-h1-sm sm:text-h1-base">Court Assistance.</h1>
            ...
            <Section className="md:pb-[30px] md:pt-[30px] text-navy">
                <div className={`md:grid grid-cols-12 `}>
                    <div className={`text-center sm:text-left p-[20px] sm:p-[60px] col-span-9 min-h-[500px] `}>
                        <h2 className="text-h2-sm sm:text-h2-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit.?</h2>
                        <br/>
