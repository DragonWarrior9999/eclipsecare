        ...
        <>
            <HeroV2>
                <div className="text text-center sm:text-left">
                    <p>Our services</p>
                    <h1 className="text-h1-sm sm:text-h1-base">Group Activity.</h1>
            ...
            <Section className="md:pb-[30px] md:pt-[30px] text-navy">
                <div className={`md:grid grid-cols-12`}>
                    <div className={`p-[20px] sm:p-[60px] col-span-9 min-h-[500px] `}>
                        <h2 className="text-center sm:text-left">Lorem ipsum dolor sit amet, consectetur adipiscing elit.?</h2>
                        <br/>
